...
public class HelperSearch extends HelperBase{
    ...
    public void searchNextMonth(String city, String dataFrom, String dataTo) {
        ...
        public void searchAnyPeriodLocalDate3(String city, String dataFrom, String dataTo) {
            typeCity(city);
            LocalDate now = LocalDate.now();
            LocalDate from= LocalDate.parse(dataFrom, DateTimeFormatter.ofPattern("M/d/yyyy"));
            LocalDate to = LocalDate.parse(dataTo,DateTimeFormatter.ofPattern("M/d/yyyy"));
    ...
    public void highlighText() {
     wd.findElement(By.id("dates")).sendKeys(Keys.chord(Keys.CONTROL,"a",Keys.DELETE));
    }

    public void typeDatesInThePast(String dates) {
        pause(1000);
    ...
    public void clickOnEmptyPlace() {
        ...
        WebElement elementLocator = wd.findElement(By.cssSelector(".subtitle"));
